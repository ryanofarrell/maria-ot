...
### 2026-09-02 — Focus order optimization for related posts
- **Target:** `_layouts/post.html`
- **Finding:** Redundant tab stops due to both the image and title linking to the same post in the Related Posts section.
- **Action:** Added `aria-hidden="true"` and `tabindex="-1"` to the image link to improve screen reader and keyboard navigation experience.
