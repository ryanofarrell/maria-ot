...
- [✅] 2026-09-02 `2025-05-30-basics-motor-planning.md`
...
## 2026-09-02 — Front matter audit and fix
- **Target:** `_posts/2025-05-30-basics-motor-planning.md`
- **Finding:** Missing `description`, incorrectly formatted `tags`, non-canonical `concepts`, and `title` > 60 chars.
- **Action:** Added description, formatted tags as array, applied canonical concept slugs, and shortened title.
