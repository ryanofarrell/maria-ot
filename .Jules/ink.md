...
- [✅] 2026-08-26 `2024-01-06-five-minute-friday-blanket-rides.md`
...
## 2026-08-26 — Audit blanket rides post front matter
- **Target:** `_posts/2024-01-06-five-minute-friday-blanket-rides.md`
- **Finding:** Missing `description` field and incorrectly formatted tags in front matter. Concepts included non-canonical terms.
- **Action:** Added `description`, updated `tags` and `categories` to arrays, and updated `concepts` to canonical taxonomy slugs.
